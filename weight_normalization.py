# modified from https://www.tensorflow.org/addons/tutorials/layers_weightnormalization
# to provide weight and mean-only batch normalization
...
class MeanOnlyWeightNormalization(tf.keras.layers.Wrapper):
    ...
    @typechecked
    def __init__(self, layer: tf.keras.layers, data_init: bool = True, mean_only_batch_norm=True, mean_only_batch_norm_momentum=0.99, **kwargs):
